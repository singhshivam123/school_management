class Admin::StandardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @standard.save
        format.html { redirect_to admin_standard_url(@standard), notice: 'Standard was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @standard.update(standard_params)
        format.html { redirect_to admin_standard_url(@standard), notice: 'Standard was successfully updated.' }
  ...
  def destroy
    @standard.destroy
    respond_to do |format|
      format.html { redirect_to admin_standards_url, notice: 'Standard was successfully destroyed.' }
