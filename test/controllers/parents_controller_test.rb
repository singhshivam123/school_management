...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { address: @parent.address, email: @parent.email, gender: @parent.gender, name: @parent.name, occupation: @parent.occupation, phone: @parent.phone } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { address: @parent.address, email: @parent.email, gender: @parent.gender, name: @parent.name, occupation: @parent.occupation, phone: @parent.phone } }
